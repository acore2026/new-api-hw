...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.POST("/benchmark", middleware.RootAuth(), controller.StartChannelBenchmark)
			channelRoute.GET("/benchmark", middleware.RootAuth(), controller.GetChannelBenchmark)
			channelRoute.DELETE("/benchmark", middleware.RootAuth(), controller.CancelChannelBenchmark)
			channelRoute.GET("/benchmark/schedule", middleware.RootAuth(), controller.GetChannelBenchmarkSchedule)
			channelRoute.PUT("/benchmark/schedule", middleware.RootAuth(), controller.UpdateChannelBenchmarkSchedule)
			channelRoute.GET("/benchmark/trends", middleware.RootAuth(), controller.GetChannelBenchmarkTrends)
			...
			channelRoute.POST("/w3/oauth/start", controller.StartW3OAuth)
			channelRoute.POST("/w3/oauth/complete", controller.CompleteW3OAuth)
			channelRoute.POST("/:id/w3/oauth/start", controller.StartW3OAuthForChannel)
			channelRoute.POST("/:id/w3/oauth/complete", controller.CompleteW3OAuthForChannel)
			channelRoute.POST("/:id/w3/refresh", controller.RefreshW3ChannelCredential)
