...
type ChannelSettings struct {
	...
	MiniMaxCompatibilityEnabled    bool   `json:"minimax_compatibility_enabled,omitempty"`
	StripClaudeCodeBillingMetadata bool   `json:"strip_claude_code_billing_metadata,omitempty"`
